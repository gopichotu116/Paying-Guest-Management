...
public class AdminController {
	...
	public String checkAdminLogin(@RequestParam("email") String email, @RequestParam("password") String password,
			Model model) {
	...
	public String addLocationForm(@RequestParam("location") String location, @RequestParam("area") String area,
			Model model) {
